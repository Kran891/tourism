...
const FixedLinks:React.FC=()=>{
    return <div className="">
        ...
        <a className="group " href="#"><div className='group-hover:text-lg group-hover:transition-all text-center right-20 lg:right-0 w-fit lg:left-12  p-3 px-4 bg-green-500 font-mono  fixed rounded-full bottom-[10%] flex items-center gap-x-1'><FaWhatsapp color='white' size={30}/><span className='hidden lg:inline text-white'>Message Us</span></div> </a>
    </div>
}
